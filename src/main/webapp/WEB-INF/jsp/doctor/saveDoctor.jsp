...
<body>
    ...
    <div class="content">
        <div class="container-fluid">
            <h1 class="main-heading mt-4">Add New Doctor</h1>
            <p class="text-muted">Fill out the form below to register a new doctor.</p>
            <div class="card p-5 shadow-sm rounded-lg">
                <div class="card-body">
                    <h2 class="card-title fw-bold text-center text-primary mb-5">Doctor Registration Form</h2>
                    <form action="addDoctorServlet" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="invalid-feedback">
                                        Age must be between 25 and 100.
                                    </div>
                                </div>
                                <div class="col-md-4">
                        ...
                        <div class="mb-5">
                            <h5 class="legend">Professional Details</h5>
                            <hr class="mt-0">
                            <div class="row g-4">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="consultationFee" name="consultationFee" required>
                                        <div class="invalid-feedback">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="availableDays" name="availableDays" placeholder="e.g., Mon, Tue, Wed, Fri" required>
                                    <div class="invalid-feedback">
                                        Please specify available days.
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label for="availableTime" class="form-label">Available Time</label>
                                    <input type="text" class="form-control" id="availableTime" name="availableTime" placeholder="e.g., 9:00 AM - 5:00 PM" required>
                                    <div class="invalid-feedback">
                                        Please specify available time.
                                    </div>
                                </div>
                            </div>
                        </div>
