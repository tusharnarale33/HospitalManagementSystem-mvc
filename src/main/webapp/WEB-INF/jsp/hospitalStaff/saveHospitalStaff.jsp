...
<head>
    ...
    <title>Add Hospital Staff - Hospital Management System</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-dark">
                <li><a class="dropdown-item" href="add_patient.jsp">Add Patient</a></li>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-dark">
                <li><a class="dropdown-item" href="Patient/savePatient">Add Staff</a></li>
    ...
    <div class="content">
        <div class="container-fluid">
            <h1 class="main-heading mt-4">Add New Hospital Staff</h1>
            <p class="text-muted">Fill out the form below to register new staff.</p>
            <div class="card p-5 shadow-sm rounded-lg">
                <div class="card-body">
                    <h2 class="card-title fw-bold text-center text-primary mb-5">Staff Registration Form</h2>
                    <form action="saveHospitalStaff" method="post" class="needs-validation" novalidate>
                        
                        <div class="mb-5">
                            <h5 class="legend">Personal Details</h5>
                            <hr class="mt-0">
                            <div class="row g-4">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="invalid-feedback">
                                        Please enter the staff's qualification.
                                    </div>
                                </div>
                                <div class="col-12">
                        ...
                        <div class="mb-5">
                            <h5 class="legend">Job Details</h5>
                            <hr class="mt-0">
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <div class="invalid-feedback">
                                        Please specify the staff's role.
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label for="assignedDepartment" class="form-label">Assigned Department</label>
                                    <input type="text" class="form-control" id="assignedDepartment" name="assignedDepartment" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="shiftTiming" name="shiftTiming" placeholder="e.g., 9:00 AM - 5:00 PM" required>
                                    <div class="invalid-feedback">
                                        Please specify the shift timing.
                                    </div>
                                </div>
                                <div class="col-md-6">
